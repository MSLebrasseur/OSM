report 50121 "Standard Sales Invoice Des1306"
{
    ...
    RDLCLayout = './Standard Sales Invoice Des1306.rdlc';
    WordLayout = './Standard Sales Invoice Des1306.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            RequestFilterHeadingML = ENU = 'Posted Sales Invoice', ESM = 'Histórico facturas venta', FRC = 'Fact. vente reportée', ENC = 'Posted Sales Invoice';
    ...
    var
        ...
        CompanyInfoPhoneNoLbl: TextConst ENU = 'Phone No: ', FRA = 'N° Tel: ', ESM = 'Nº Tel: ', FRC = 'N° Tél: ', ENC = 'Phone No: ';
        ...
        FormatDocumentOSM: Codeunit "FormatDocumentOSM";
    ...
    begin
        ...
        FillNameValueTable(RightHeader, CompanyInfoFaxNoLbl, CompanyInfo."Fax No.");
    ...
    begin
        WITH SalesInvoiceHeader DO BEGIN
            ...
            FormatDocumentOSM.SetTotalLabelsOSM(GetCurrencySymbol, TotalText, TotalInclVATText, TotalExclVATText);
            //GES End
