report 50100 "Check (Stub/Check/Stub) OSM"
{
    // version NAVNA13.00

    // GES.001- Ligne 713 et 720, enlever * dans le ChechAmountText
    DefaultLayout = RDLC;
    RDLCLayout = './Check (StubCheckStub) OSM.rdlc';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(GenJnlLine_Bal_Account_No; GenJnlLine."Bal. Account No.")
            {
            }
            dataitem(CheckPages; Integer)
            {
                ...
                column(CheckDateText; FORMAT(GenJnlLine."Posting Date", 0, '<Year4>-<Month,2>-<Day,2>'))
                {
                }
                ...
                dataitem(PrintSettledLoop; Integer)
                {
                    ...
                    column(DocDate; FORMAT(DocDate, 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                ...
                dataitem(PrintCheck; Integer)
                {
                    ...
                    column(CheckDateText_Control1480021; FORMAT(GenJnlLine."Posting Date", 0, '<Year4> <Month,2> <Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_1_; FORMAT(Stub2DocDate[1], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_2_; FORMAT(Stub2DocDate[2], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_3_; FORMAT(Stub2DocDate[3], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_4_; FORMAT(Stub2DocDate[4], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_5_; FORMAT(Stub2DocDate[5], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_6_; FORMAT(Stub2DocDate[6], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_7_; FORMAT(Stub2DocDate[7], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_8_; FORMAT(Stub2DocDate[8], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_9_; FORMAT(Stub2DocDate[9], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                    ...
                    column(Stub2DocDate_10_; FORMAT(Stub2DocDate[10], 0, '<Year4>-<Month,2>-<Day,2>'))
                    {
                    }
                ...
                group(Options)
                {
                    ...
                    field(BankAccount; BankAcc2."No.")
                    {
                        ...
                        ToolTipML = ENU = 'Specifies the bank account that the check will be drawn from.',
                                    ...
                                    FRC = 'Spécifie le compte bancaire à partir duquel le chèque sera tiré.',
                    ...
                    field(UseCheckNo; UseCheckNo)
                    {
                        ...
                        ToolTipML = ENU = 'Specifies the number of the last check that was issued. If you have entered a number in the Last Check No. field in the Bank Account Card window, the number will appear here when you fill in the Bank Account field.',
                                    ESM = 'Especifica el número del último cheque emitido. Si especificó un número en el campo Últ. n.º cheque de la ventana Ficha banco, el número aparecerá aquí cuando rellene el campo Banco.',
                    ...
                    field(CommitEachCheck; CommitEachCheck)
                    {
                        ...
                        ToolTipML = ENU = 'Specifies if you want each check to commit to the database after printing instead of at the end of the print job. This allows you to avoid differences between the data and check stock on networks where the print job is cached.',
                                    ...
                                    ENC = 'Specifies if you want each cheque to commit to the database after printing instead of at the end of the print job. This allows you to avoid differences between the data and cheque stock on networks where the print job is cached.';
                    }
                }
            }
        }
    ...
    var
        ...
        Text062: TextConst ENU = 'G/L Account,Customer,Vendor,Bank Account,,,Employee', ESM = 'Cuenta,Cliente,Proveedor,Cuenta bancaria,,,Empleado', FRC = 'Compte du grand livre,Client,Fournisseur,Compte bancaire,,,Employé', ENC = 'G/L Account,Customer,Vendor,Bank Account,,,Employee';
        ...
        AlreadyAppliedToEmployeeErr: TextConst Comment = '%1 = Document type, %2 = Document No., %3 = Employee No.', ENU = ' is already applied to %1 %2 for employee %3.', ESM = ' ya se aplicó a %1 %2 para el empleado %3.', FRC = ' est déjà affecté(e) à %1 %2 pour l''employé %3.', ENC = ' is already applied to %1 %2 for employee %3.';
        BlockedEmplForCheckErr: TextConst Comment = '%1 - Employee no.', ENU = 'You cannot print check because employee %1 is blocked due to privacy.', ESM = 'No puede imprimir el cheque porque el empleado %1 está bloqueado por motivos de privacidad.', FRC = 'Vous ne pouvez pas imprimer de chèque, car l''employé %1 est bloqué en raison de la confidentialité.', ENC = 'You cannot print cheque because employee %1 is blocked due to privacy.';
